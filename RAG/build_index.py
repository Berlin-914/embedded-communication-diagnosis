...
# Render resolution for full-page / full-slide visual analysis
RENDER_SCALE = 1.5
...
def vlm_explain_image(
    ...
    print()
    print(
        f"    VLM analysing: {source} {location}"
    )
    ...
    for page_number, page in enumerate(
        ...
        for image_number, image_info in enumerate(
            ...
            try:
                ...
                print(
                    f"    PDF image warning: {e}"
                )

        # ====================================================
        # WHOLE PAGE VISUAL ANALYSIS
        # ====================================================
        #
        # IMPORTANT FIX:
        #
        # We now render EVERY PDF page.
        #
        # This allows Qwen2.5-VL to understand
        # vector diagrams even when:
        #
        # page.get_images() == []
        #
        # ====================================================
        ...
        try:
            ...
            rendered_bytes = render_pdf_page(
                page
            )
            ...
            explanation = (
                vlm_explain_image(
                    ...
                    f"page {page_number} full-page visual"
                )
            )
...
def process_rendered_ppt(
    ...
    print()
    print(
        "  VLM analysing complete PPT slides..."
    )
    ...
    for slide_number, page in enumerate(
        document,
        start=1
    ):
...
def process_pptx(
    ...
    rendered_pdf = render_ppt_to_pdf(
        ppt_path
    )
...
def find_files():
    ...
    # Ignore Microsoft temporary files
    files = [
        f
        for f in files
...
def check_ollama():
    ...
    try:
        ...
        print()
        print(
            f"WARNING: {VLM_MODEL} was not found."
        )
        ...
        print(
            f"WARNING: Ollama connection failed: {e}"
        )
...
def main():
    ...
    print("=" * 70)
    print(
        "MULTIMODAL RAG - QWEN2.5-VL INDEX BUILDER"
    )
    print("=" * 70)
    ...
    print()
    print(
        f"Found {len(files)} input file(s)."
    )

    for file in files:

        print(
            f"  - {file.relative_to(DATA_DIR)}"
        )
    ...
    if not files:
        ...
        print()
        print(
            "No PDF/PPT/PPTX/Excel files found."
        )
    ...
    print("=" * 70)
    print(
        "MULTIMODAL INDEX BUILD COMPLETE"
    )
    print("=" * 70)
    ...
    print()
    print(
        "The multimodal RAG index is ready."
    )
